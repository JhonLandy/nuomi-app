        ...
        32501: (e, t, n) => {
            ...
            function p(e, t, n) {
                ...
                if (((r += e.messageText), n++, e.next))
                    for (let o = 0, s = e.next; o < s.length; o++) {
                        let a = s[o];
                        r += p(a, t, n);
                    }
                return r;
                ...
                m = (function () {
                    ...
                    return (
                        (e.prototype.isLibFile = function (e) {
                            return !!e && 0 === e.path.indexOf("/lib.") && !!u[e.path.slice(1)];
                        }),
                        (e.prototype.getOrCreateModel = function (e) {
                            let t = i.j6.getModel(e);
                            return (
                                t ||
                    ...
                    function t(t, n, r, o) {
                        ...
                        let a = function (e) {
                                if (e.getModeId() === r) {
                                    let t,
                                        n = function () {
                                            let t = s._defaults.getDiagnosticsOptions().onlyVisible;
                                            t
                                        ...
                                        a = e.onDidChangeAttached(function () {
                                            ...
                                            t &&
                                                (e.isAttachedToEditor()
                                                    ? n()
                                                    : i.j6.setModelMarkers(e, s._selector, []));
                                        });
                        ...
                        s._disposables.push(
                            i.j6.onDidCreateModel(function (e) {
                                return a(e);
                            })
                        ),
                            s._disposables.push(i.j6.onWillDisposeModel(u)),
                            s._disposables.push(
                            ...
                            s._disposables.push({
                                dispose: function () {
                                    for (let e = 0, t = i.j6.getModels(); e < t.length; e++) {
                                        let n = t[e];
                                        u(n);
                                    }
                                },
                    ...
                    return (
                                            ...
                                            return (
                                                ...
                                                e.isDisposed()
                                                    ...
                                                    : ((n = []),
                                                      ...
                                                      o ||
                                                          n.push(
                                                              t.getSyntacticDiagnostics(
                                                                  e.uri.toString()
                                                              )
                                                          ),
                                                      s ||
                                                          n.push(
                                                              t.getSemanticDiagnostics(
                                                                  e.uri.toString()
                                                              )
                                                          ),
                                                      a ||
                                                          n.push(
                                                              t.getSuggestionDiagnostics(
                                                                  e.uri.toString()
                                                              )
                                                          ),
                                                      [4, Promise.all(n)])
                        ...
                        (t.prototype._convertDiagnostics = function (e, t) {
                            let n = t.start || 0,
                                ...
                                d = [];
                            return (
                                t.reportsUnnecessary && d.push(i.eB.Unnecessary),
                                t.reportsDeprecated && d.push(i.eB.Deprecated),
                                {
                            ...
                            if (t) {
                                ...
                                return (
                                    t.forEach(function (t) {
                                        let o = e;
                                        if (t.file) {
                                            let s = i.Sf.parse(t.file.fileName);
                    ...
                    return (
                                                ...
                                                a
                                                    ? [
                                                          2,
                                                          {
                                                              ...
                                                              documentation: {
                                                                  value: t.createDocumentationString(
                                                                      a
                                                                  ),
                                                              },
                                                          },
                        ...
                        (t.convertKind = function (e) {
                            switch (e) {
                                ...
                                case M.keyword:
                                    return i.Mj.CompletionItemKind.Keyword;
                                case M.variable:
                                case M.localVariable:
                                    return i.Mj.CompletionItemKind.Variable;
                                case M.memberVariable:
                                case M.memberGetAccessor:
                                case M.memberSetAccessor:
                                    return i.Mj.CompletionItemKind.Field;
                                case M.function:
                                case M.memberFunction:
                                case M.constructSignature:
                                case M.callSignature:
                                case M.indexSignature:
                                    return i.Mj.CompletionItemKind.Function;
                                case M.enum:
                                    return i.Mj.CompletionItemKind.Enum;
                                case M.module:
                                    return i.Mj.CompletionItemKind.Module;
                                case M.class:
                                    return i.Mj.CompletionItemKind.Class;
                                case M.interface:
                                    return i.Mj.CompletionItemKind.Interface;
                                case M.warning:
                                    return i.Mj.CompletionItemKind.File;
                            }
                            return i.Mj.CompletionItemKind.Property;
                        }),
                        (t.createDocumentationString = function (e) {
                            let t = f(e.documentation);
                            if (e.tags)
                                for (let n = 0, r = e.tags; n < r.length; n++) {
                                    let i = r[n];
                                    t += "\n\n" + y(i);
                                }
                            return t;
            ...
            var _ = (function (e) {
                    function t() {
                        let t = (null !== e && e.apply(this, arguments)) || this;
                    ...
                    return (
                        ...
                        (t._toSignatureHelpTriggerReason = function (e) {
                            switch (e.triggerKind) {
                                case i.Mj.SignatureHelpTriggerKind.TriggerCharacter:
                                    return e.triggerCharacter
                                        ...
                                        : { kind: "invoked" };
                                case i.Mj.SignatureHelpTriggerKind.ContentChange:
                                    return e.isRetrigger
                                        ? { kind: "retrigger" }
                                        : { kind: "invoked" };
                                case i.Mj.SignatureHelpTriggerKind.Invoke:
                                default:
                                    return { kind: "invoked" };
                            }
                        }),
                                                ...
                                                e.isDisposed()
                                                    ...
                                                    : [
                                                          ...
                                                          s.getSignatureHelpItems(r.toString(), o, {
                                                              triggerReason:
                                                                  t._toSignatureHelpTriggerReason(
                                                                      i
                                                                  ),
                                                          }),
                                                      ]
                                                ...
                                                !a || e.isDisposed()
                                                    ...
                                                    : ((u = {
                                                      ...
                                                      a.items.forEach(function (e) {
                                                          let t = { label: "", parameters: [] };
                                                          (t.documentation = {
                                                              value: f(e.documentation),
                                                          }),
                                                              (t.label += f(e.prefixDisplayParts)),
                                                              e.parameters.forEach(function (
                                                                  n,
                                                                  r,
                                                                  i
                                                              ) {
                                                                  let o = f(n.displayParts),
                                                                      s = {
                                                                          label: o,
                                                                          documentation: {
                                                                              value: f(
                                            ...
                                            return (
                                                ...
                                                !s || e.isDisposed()
                                                    ...
                                                    : [
                                                          ...
                                                          s.map(function (t) {
                                                              return {
                                                                  range: a._textSpanToRange(
                                                                      e,
                                                                      t.textSpan
                                                                  ),
                                                                  kind: t.isWriteAccess
                                                                      ? i.Mj.DocumentHighlightKind
                                                                            .Write
                                                                      : i.Mj.DocumentHighlightKind
                                                                            .Text,
                                                              };
                                            ...
                                            return (
                                                ...
                                                !r || e.isDisposed()
                                                    ...
                                                    : ((o = function (t, n, r) {
                                                          ...
                                                          if (
                                                              n.childItems &&
                                                              n.childItems.length > 0
                                                          )
                                                              for (
                                                                  let u = 0, l = n.childItems;
                                                                  u < l.length;
                                                                  u++
                                                              ) {
                                                                  let c = l[u];
            ...
            (j[M.module] = i.Mj.SymbolKind.Module),
                (j[M.class] = i.Mj.SymbolKind.Class),
                (j[M.enum] = i.Mj.SymbolKind.Enum),
                (j[M.interface] = i.Mj.SymbolKind.Interface),
                (j[M.memberFunction] = i.Mj.SymbolKind.Method),
                (j[M.memberVariable] = i.Mj.SymbolKind.Property),
                (j[M.memberGetAccessor] = i.Mj.SymbolKind.Property),
                (j[M.memberSetAccessor] = i.Mj.SymbolKind.Property),
                (j[M.variable] = i.Mj.SymbolKind.Variable),
                (j[M.const] = i.Mj.SymbolKind.Variable),
                (j[M.localVariable] = i.Mj.SymbolKind.Variable),
                (j[M.variable] = i.Mj.SymbolKind.Variable),
                (j[M.function] = i.Mj.SymbolKind.Function),
                (j[M.localFunction] = i.Mj.SymbolKind.Function);
            let D,
                F,
                I = (function (e) {
                    function t() {
                    ...
                    return (
                        ...
                        (t.prototype._tsCodeFixActionToMonacoCodeAction = function (e, t, n) {
                            for (var r = [], i = 0, o = n.changes; i < o.length; i++)
                                for (let s = o[i], a = 0, u = s.textChanges; a < u.length; a++) {
                                    let l = u[a];
                                    r.push({
                                        resource: e.uri,
                                        edit: {
            ...
            function R(e, t) {
                let n = new a(t, e),
                    ...
                    o = new m(r);
                return (
                    i.Mj.registerCompletionItemProvider(t, new v(r)),
                    i.Mj.registerSignatureHelpProvider(t, new _(r)),
                    i.Mj.registerHoverProvider(t, new S(r)),
                    i.Mj.registerDocumentHighlightProvider(t, new w(r)),
                    i.Mj.registerDefinitionProvider(t, new k(o, r)),
                    i.Mj.registerReferenceProvider(t, new x(o, r)),
                    i.Mj.registerDocumentSymbolProvider(t, new C(r)),
                    i.Mj.registerDocumentRangeFormattingEditProvider(t, new T(r)),
                    i.Mj.registerOnTypeFormattingEditProvider(t, new P(r)),
                    i.Mj.registerCodeActionProvider(t, new L(r)),
                    i.Mj.registerRenameProvider(t, new A(r)),
                    new b(o, e, t, r),
                    r
                );
            }
